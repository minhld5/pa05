...
<form action="{{@Config::get('app.url')}}/admin/department/create/{{$unit->id}}" method="post">
    ...
    <div class="form-horizontal" style="width:99%; align-content: center; margin: 15px;">
        <div class="widget" style="width:99%; align-content: center;">
            ...
            <div class="widget-header"><h4>Thêm trung tâm, phòng ban thuộc {{$unit->name}}</h4></div>
        ...
        <div class="form-horizontal" style="width:99%; align-content: center; margin: 15px;">
            <div class="form-actions" align = "center">
                <p class="btn-toolbar btn-toolbar-demo">
                    <a href="{{@Config::get('app.url')}}/admin/department/list/{{$unit->id}}">
