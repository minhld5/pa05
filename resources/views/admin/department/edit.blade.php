...
<form action="{{@Config::get('app.url')}}/admin/department/edit/{{$department->id}}" method="post">
    ...
    <div class="form-horizontal" style="width:99%; align-content: center; margin: 15px;">
        <div class="widget" style="width:99%; align-content: center;">
            ...
            <div class="widget-header"><h4>Cập nhật thông tin trung tâm, phòng ban</h4></div>
                ...
                <div class="widget-content">
                    <div class="row">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">Tên bộ phận:</label>
                            <div class="col-md-2">
        ...
        <div class="form-horizontal" style="width:99%; align-content: center; margin: 15px;">
            <div class="form-actions" align = "center">
                <p class="btn-toolbar btn-toolbar-demo">
                    <a href="{{@Config::get('app.url')}}/admin/department/list/{{$department->sys_unit_id}}">
