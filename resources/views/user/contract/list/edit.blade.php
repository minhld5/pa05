...
<div class="tab-pane" id="tab_edit_account">
	<form class="form-horizontal" action="{{@Config::get('app.url')}}/user/contract/list/edit/{{$contract_list->id}}" method="post">
		{{csrf_field()}}
		<div class="col-md-12">
			<div class="widget">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" name="overall_status" class="form-control" value="{{$contract_list->overall_status}}" placeholder="Ví dụ: Đã ký hợp đồng">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" name="delivery_schedule" class="form-control" value="{{$contract_list->delivery_schedule}}" placeholder="Ví dụ: Đã bàn giao xong">
								</div>
							</div>
