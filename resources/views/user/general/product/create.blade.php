...
<form action="{{@Config::get('app.url')}}/user/general/product/create/{{$sub_group->id}}" method="post" enctype="multipart/form-data">
                ...
                <div class="widget-content">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" name="short_description" value="" rows="3"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" name="long_description" value="" rows="5"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input id="total" class="form-control" name="origin" value="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" name="spec" value="" rows="5"></textarea>
                            </div>
                        </div>  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input class="form-control" name="refer_2517" value="">
                            </div>
                        </div>
