...
<form action="{{@Config::get('app.url')}}/user/general/product/price_edit/{{$price->id}}" method="post">
    ...
    <div class="form-horizontal" style="width:99%; align-content: center; margin: 15px;">
        <div class="widget" style="width:99%; align-content: center;">
            ...
            <div class="widget-header"><h4>Chỉnh sửa giá tiền</h4></div>
                ...
                <div class="widget-content">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <input type="text" class="form-control" name="warranty_year" value="{{$price->warranty_year}}" placeholder="ví dụ 5 năm" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input id="price" class="form-control just-number price-format-input" name="price" value="{{number_format($price->price)}}">
                            </div>
                        </div>
        ...
        <div class="form-horizontal" style="width:99%; align-content: center; margin: 15px;">
            <div class="form-actions" align = "center">
                <p class="btn-toolbar btn-toolbar-demo">
                    <a href="{{@Config::get('app.url')}}/user/general/product/edit/{{$price->general_product_id}}">
