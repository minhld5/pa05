...
<form action="{{@Config::get('app.url')}}/user/pa05/category_detail/edit/{{$category_detail->id}}" method="post">
                ...
                <div class="widget-content">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <input type="number" class="form-control" name="no" value="{{$category_detail->no}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" name="name" value="{{$category_detail->name}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <select class="form-control" name="type">
                                    <option value="hardware" <?php if ($category_detail->type=='hardware'){echo 'selected';} ?> >Hardware</option>
                                    <option value="software" <?php if ($category_detail->type=='software'){echo 'selected';} ?> >Software</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="form-control" id="brand" name="brand" value="{{$category_detail->brand}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="form-control" id="model" name="model" value="{{$category_detail->model}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="form-control" id="origin" name="origin" value="{{$category_detail->origin}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" rows="7" id="spec" name="spec">{{$category_detail->spec}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <input type="text" class="form-control" name="unit" value="{{$category_detail->unit}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" id="refer_2517" name="refer_2517" value="{{$category_detail->refer_2517}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" rows="7" id="note" name="note">{{$category_detail->note}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input class="form-control" id="selected_product" name="selected_product" value="{{$category_detail->product_name}}" readonly>
                            </div>
                        </div>
        ...
        <div class="form-horizontal" style="width:99%; align-content: center; margin: 15px;">
            <div class="form-actions" align = "center">
                <p class="btn-toolbar btn-toolbar-demo">
                    <a href="{{@Config::get('app.url')}}/user/pa05/category_detail/list/{{$category_detail->categoryid}}">
