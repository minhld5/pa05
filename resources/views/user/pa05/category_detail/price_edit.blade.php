...
<form action="{{@Config::get('app.url')}}/user/pa05/category_detail/price_edit/{{$price->id}}" method="post">
                ...
                <div class="widget-content">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input id="price" class="form-control just-number price-format-input" name="price" value="{{number_format($price->price)}}" required>
                            </div>
                        </div>
        ...
        <div class="form-horizontal" style="width:99%; align-content: center; margin: 15px;">
            <div class="form-actions" align = "center">
                <p class="btn-toolbar btn-toolbar-demo">
                    <a href="{{@Config::get('app.url')}}/user/pa05/category_detail/price_list/{{$price->pa05_category_detail_id}}">
